export const firstListQuestions = [
...

  {
    ...
    impressoras, computadores, desktops, pilhas, baterias, tablets, teclados,
    monitores (LED e LCD), mouses e muitos outros.`,
  },

  {
    ...
    nossa ferramenta de localização. Lá você terá acesso aos pontos de coleta disponíveis
    e poderá verificar se eles aceitam o tipo de produto que você deseja descartar.`,
  },

  {
    ...
    answer: `Clique aqui e envie um e-mail informando sua empresa, localização e os tipos de
    equipamentos que você deseja destinar, juntamente com a quantidade aproximada. Se possível,
    inclua fotos para uma melhor avaliação. Nossa equipe entrará em contato o mais breve possível
    para dar continuidade ao seu atendimento.`,
  },
  {
    id: 5,
    question: `A EcoSempre faz parceria com condomínios para a coleta e 
    destinação adequada de lixo eletrônico?`,
    answer: `Sim, a EcoSempre está aberta a parcerias com condomínios interessados em promover a
    coleta e destinação adequada de lixo eletrônico. Temos programas especiais para condomínios que
...
export const secondListQuestions = [
  {
    ...
    answer: `A Logística Reversa é o processo de coletar, transportar,
      ...
      visa minimizar o impacto ambiental e promover a recuperação de materiais
      valiosos.`,
  },
  {
    id: 7,
    ...
    das empresas em relação à responsabilidade ambiental.`,
  },
  {
    id: 8,
  ...
  },
  {
    ...
    redes sociais para ficar por dentro e para saber quando e onde estaremos presentes.`,
  },
  {
    id: 10,
    ...
    answer: `Com certeza! Entre em contato conosco informando o nome da entidade que você representa, a
